...
SECTIONS = [
    ...
    },
    {
        ...
        "items": [
            ...
            {"id": "m6", "label": "10 min outdoor light + red light sauna 15 min", "note": "COMT Val/Val: morning light + red light + movement is your most powerful dopamine stack. Red light sauna first (mitochondrial ATP, prefrontal support, circadian signal) then outdoor light. Both before cycling.", "tag": "crit", "tagLabel": "9:05–9:20 AM"},
            {"id": "m7", "label": "Cycling: 20–30 min moderate pace (Prospect Park or stationary)", "note": "Core daily feature — not optional. Moderate pace only. Cycling within 2 hrs of TMS amplifies neuroplasticity. Raises prefrontal dopamine for COMT Val/Val. Lowers homocysteine. Improves HDL.", "tag": "crit", "tagLabel": "9:20–9:50 AM"},
            {"id": "m2", "label": "Breakfast — 2 eggs + greens + berries", "note": "After cycling · eggs (choline) · spinach/arugula (natural folate) · blueberries (anti-neuroinflammation) · eat within 45 min of finishing ride", "tag": "key", "tagLabel": "~10:00 AM"},
    ...
    },
    {
        ...
        "xpEach": 5,
        "items": [
            {"id": "e1", "label": "Morning cycling DONE (logged in morning routine above)", "note": "Core daily ride in morning block 9:20-9:50 AM · check here to confirm · if missed: do it now before 2 PM — still within TMS amplification window", "tag": "crit", "tagLabel": "Core"},
            ...
            {"id": "e6", "label": "Second short ride or walk 15–20 min (afternoon — optional)", "note": "Optional but powerful on TMS days — BDNF peaks again 90-120 min after second session · keep moderate pace", "tag": "daily", "tagLabel": "Optional"},
